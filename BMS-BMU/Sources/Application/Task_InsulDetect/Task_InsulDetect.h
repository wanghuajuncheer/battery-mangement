...
#define _TASK_INSULDETECT_H_
   ...
   //#define Resistance_Alarm1   1000        //绝缘电阻故障等级阈值（未定）
   #define Resistance_Alarm2   (100*CELL_VOLT_MAX*SYS_SERIES_YiDongLi/1000.0) //绝缘电阻故障等级阈值 （未定） 
   ...
   typedef struct
   {
     ...
     float  insulation_Vposit;              //对正电压,(数字量)
     float  insulation_Vnegt;               //对负电压,(数字量)
